...
from config import EMPLOYEE_ROLES, SS_COL_MAP, NS_COL_MAP, PHASE_BENCHMARKS, ACTIVE_EMPLOYEES
from config import NAVY, TEAL, WHITE, LTGRAY, AVAIL_HOURS, EMPLOYEE_LOCATION, PS_REGION_OVERRIDE, PS_REGION_MAP
...
def build_phase_duration(ss_df, milestone_cols):
    ...
    from config import MILESTONE_COLS_MAP as _MCM
    df = ss_df.copy()
...
def main():
    ...
    try:
        ...
        if _session_name:
            from config import get_role as _get_role, resolve_view_as, get_region_consultants
            from config import EMPLOYEE_LOCATION as _EL2, PS_REGION_MAP as _RM2, PS_REGION_OVERRIDE as _RO2
            from config import ACTIVE_EMPLOYEES as _AE2
            from config import CONSULTANT_DROPDOWN as _CD2
