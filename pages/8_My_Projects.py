...
_hero.markdown(
    ...
    f"color:#3B9EFF;margin-bottom:10px;font-family:Manrope,sans-serif'>Professional Services · My Work</div>"
    f"<h1 style='color:#fff;margin:0;font-size:28px;font-weight:800;font-family:Manrope,sans-serif;"
    f"line-height:1.15'>My Projects — {_dn}</h1>"
    f"<p style='color:rgba(255,255,255,0.6);margin:8px 0 0;font-size:14px;font-family:Manrope,sans-serif;"
    f"line-height:1.6'>{today.strftime('%A, %B %-d %Y')} · {len(active)} active · {len(on_hold)} on hold</p>"
    f"</div>",
    unsafe_allow_html=True,
)
