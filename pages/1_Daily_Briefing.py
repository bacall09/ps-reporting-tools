...
if not my_ns.empty and "date" in my_ns.columns and "hours" in my_ns.columns:
    ...
    _hero.markdown(
        ...
        f"<div style='display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin-top:18px;padding-top:16px;border-top:0.5px solid rgba(255,255,255,0.1);'>"
        f"<div><div style='font-size:10px;text-transform:uppercase;letter-spacing:0.6px;color:rgba(255,255,255,0.4);margin-bottom:4px;'>Week util</div>"
        ...
        f"{f'{_wk_total}h / {_wk_billable_h}h billable' if _wk_total is not None else 'No data'}</div>"
        f"<div style='margin-top:4px;'>{_pace_badge}</div></div>"
        f"<div><div style='font-size:10px;text-transform:uppercase;letter-spacing:0.6px;color:rgba(255,255,255,0.4);margin-bottom:4px;'>Month util</div><div style='font-size:26px;font-weight:600;color:#fff;line-height:1.1;'>{str(round(util_pct,1))+'%' if util_pct is not None else '—'}</div><div style='font-size:12px;color:rgba(255,255,255,0.55);margin-top:3px;'>{_fmt_hrs(util_hrs) if util_hrs else '—'} credited</div><div style='font-size:12px;color:rgba(255,255,255,0.45);margin-top:2px;'>of {_fmt_hrs(avail)} avail · target 70%</div></div>"
