...
def main():
    ...
    if _loaded:
        ...
        with col1:
            st.markdown('<div class="section-label">Step 1 — Upload Smartsheets DRS Export</div>', unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="section-label">Step 2 — Upload NS Unassigned Projects</div>', unsafe_allow_html=True)
    ...
    if _sfdc_from_session is None:
        st.markdown('<div class="section-label">Step 3 — Upload SFDC Closed Won PS Opps (Optional)</div>', unsafe_allow_html=True)
    ...
    # ── Tab 1: Heatmap ─────────────────────────────────────────────────────────
    with tab1:
        st.markdown('<div class="section-label">Unassigned Projects — Closed Deals Awaiting Staffing</div>', unsafe_allow_html=True)
    ...
    with tab2:
        st.markdown('<div class="section-label">Consultant Availability — Next 6 Months</div>', unsafe_allow_html=True)
    ...
    with tab3:
        st.markdown('<div class="section-label">Consultant Capacity Detail</div>', unsafe_allow_html=True)
        detail_rows = []
    ...
    with tab4:
        st.markdown('<div class="section-label">Regional Capacity vs Demand</div>', unsafe_allow_html=True)
